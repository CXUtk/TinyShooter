...
// 装逼用的
// 企业级开发标准
#ifdef _MSC_VER        // 编译器要给予特殊照顾
#if _MSC_VER <=1200    // VC++6.0及以下版本
#error 你是不是还在用Visual C++ 6.0以下的版本
#else                  
#if _MSC_VER <= 1800   //支持stdint的版本
#include <stdint.h>
#endif
#ifndef __cplusplus    // VC++都没有stdbool.h,不用C++编译，自己定义bool
typedef int bool;
#define true 1
#define false 0
#endif
